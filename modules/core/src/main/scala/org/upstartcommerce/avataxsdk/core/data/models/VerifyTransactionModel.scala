...
final case class VerifyTransactionModel(verifyTransactionDate: Option[Instant] = None, verifyTotalAmount: Option[BigDecimal] = None, verifyTotalTax: Option[BigDecimal] = None) {
