...
final case class BatchModel(id: Option[Int] = None, name: String, accountId: Option[Int] = None, companyId: Option[Int] = None, `type`: BatchType, status: Option[BatchStatus] = None, options: Option[String] = None, batchAgent: Option[String] = None, startedDate: Option[Instant] = None, recordCount: Option[Int] = None, currentRecord: Option[Int] = None, completedDate: Option[Instant] = None, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None, files: Option[List[BatchFileModel]] = None) {
