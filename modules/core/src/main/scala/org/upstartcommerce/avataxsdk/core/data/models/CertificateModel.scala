...
final case class CertificateModel(id:Option[Int] = None, companyId:Option[Int] = None, signedDate:Date, expirationDate:Date, filename:Option[String] = None,
                                  ...
                                  exemptionReason:ExemptionReasonModel, status:Option[String] = None, createdDate:Option[Date] = None, modifiedDate:Option[Date] = None, pageCount:Option[Int] = None, customers:Option[List[CustomerModel]] = None, poNumbers:Option[List[PoNumberModel]] = None, exposureZone:Option[ExposureZoneModel] = None, attributes:Option[List[CertificateAttributeModel]] = None, pdf:Option[String] = None, pages:Option[List[String]] = None) {
