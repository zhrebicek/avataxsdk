...
final case class MultiDocumentModel(id: Option[Long] = None, accountId: Option[Int] = None, code: Option[String] = None, `type`: Option[DocumentType] = None, createdUserId: Option[Int] = None, createdDate: Option[Instant] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None, documents: Option[List[TransactionModel]] = None) {
  ...
  def withCreatedDate(value: Instant): MultiDocumentModel = copy(createdDate = Some(value))

  def withModifiedDate(value: Instant): MultiDocumentModel = copy(modifiedDate = Some(value))
