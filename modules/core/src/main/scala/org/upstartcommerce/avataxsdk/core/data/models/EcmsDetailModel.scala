...
final case class EcmsDetailModel(exemptCertDetailId:Int, exemptCertId:Int, stateFips:String, region:String, idNo:Option[String] = None, country:String, endDate:Option[Date] = None, idType:Option[String] = None, isTaxCodeListExclusionList:Option[Int] = None, taxCodes:Option[List[EcmsDetailTaxCodeModel]] = None) {
