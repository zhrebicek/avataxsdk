...
final case class LoginVerificationInputModel(companyId:Option[Int] = None, accountId:Option[Int] = None, region:Option[String] = None, taxFormCode:Option[String] = None, username:Option[String] = None, password:Option[String] = None, additionalOptions:Map[String, String] = Map.empty, bulkRequestId:Option[Int] = None, priority:Option[Int] = None) {
  ...
  def withAdditionalOptions(value:Map[String, String]):LoginVerificationInputModel = copy(additionalOptions = value)
