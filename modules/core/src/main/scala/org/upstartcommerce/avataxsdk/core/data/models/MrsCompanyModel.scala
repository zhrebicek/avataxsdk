...
final case class MrsCompanyModel(companyId: Option[Int] = None, companyName: Option[String] = None, accountId: Option[Int] = None, accountName: Option[String] = None, tin: Option[String] = None, companyCode: Option[String] = None, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None) {
