...
final case class CompanyDistanceThresholdModel(id: Option[Long] = None, companyId: Option[Int] = None, originCountry: String, destinationCountry: String,
                                               effDate: Option[Instant] = None, endDate: Option[Instant] = None, thresholdExceeded: Option[Boolean] = None,
                                               `type`: String) {
  ...
  def withEffDate(value: Instant): CompanyDistanceThresholdModel = copy(effDate = Some(value))

  def withEndDate(value: Instant): CompanyDistanceThresholdModel = copy(endDate = Some(value))
