...
final case class AccountConfigurationModel(accountId:Option[Int] = None, category:String, name:String, value:Option[String] = None, createdDate:Option[Date] = None, createdUserId:Option[Int] = None, modifiedDate:Option[Date] = None, modifiedUserId:Option[Int] = None) {
