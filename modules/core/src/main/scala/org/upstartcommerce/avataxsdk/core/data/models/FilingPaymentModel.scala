...
final case class FilingPaymentModel(id:Option[Long] = None, filingId:Option[Long] = None, paymentAmount:BigDecimal, `type`:PaymentType, isCalculated:Option[Boolean] = None, createdDate:Option[Date] = None, createdUserId:Option[Int] = None, modifiedDate:Option[Date] = None, modifiedUserId:Option[Int] = None) {
