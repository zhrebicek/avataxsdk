...
final case class BatchFileModel(id:Option[Int] = None, batchId:Option[Int] = None, name:Option[String] = None, content:String, contentLength:Option[Int] = None, contentType:Option[String] = None, fileExtension:Option[String] = None, filePath:Option[String] = None, errorCount:Option[Int] = None) {
