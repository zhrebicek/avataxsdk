...
final case class TaxOverrideModel(`type`: Option[TaxOverrideType] = None, taxAmount: Option[BigDecimal] = None, taxDate: Option[Instant] = None, reason: Option[String] = None) {
