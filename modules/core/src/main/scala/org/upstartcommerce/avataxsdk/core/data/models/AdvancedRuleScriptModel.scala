...
final case class AdvancedRuleScriptModel(id: Long, accountId: Option[Int] = None, crashBehavior: Option[AdvancedRuleCrashBehavior] = None, scriptType: Option[AdvancedRuleScriptType] = None, script: Option[String] = None, isApproved: Option[Boolean] = None, isDisabled: Option[Boolean] = None) {
