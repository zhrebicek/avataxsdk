...
final case class TransactionModel(id: Option[Long] = None, code: Option[String] = None, companyId: Option[Int] = None, date: Option[Instant] = None, paymentDate: Option[Instant] = None, status: Option[DocumentStatus] = None, `type`: Option[DocumentType] = None, batchCode: Option[String] = None, currencyCode: Option[String] = None, customerUsageType: Option[String] = None, entityUseCode: Option[String] = None, customerVendorCode: Option[String] = None, customerCode: Option[String] = None, exemptNo: Option[String] = None, reconciled: Option[Boolean] = None, locationCode: Option[String] = None, reportingLocationCode: Option[String] = None, purchaseOrderNo: Option[String] = None, referenceCode: Option[String] = None, salespersonCode: Option[String] = None, taxOverrideType: Option[TaxOverrideType] = None, taxOverrideAmount: Option[BigDecimal] = None, taxOverrideReason: Option[String] = None, totalAmount: Option[BigDecimal] = None, totalExempt: Option[BigDecimal] = None, totalDiscount: Option[BigDecimal] = None, totalTax: Option[BigDecimal] = None, totalTaxable: Option[BigDecimal] = None, totalTaxCalculated: Option[BigDecimal] = None, adjustmentReason: Option[AdjustmentReason] = None, adjustmentDescription: Option[String] = None, locked: Option[Boolean] = None, region: Option[String] = None, country: Option[String] = None, version: Option[Int] = None, softwareVersion: Option[String] = None, originAddressId: Option[Long] = None, destinationAddressId: Option[Long] = None, exchangeRateEffectiveDate: Option[Instant] = None, exchangeRate: Option[BigDecimal] = None, isSellerImporterOfRecord: Option[Boolean] = None, description: Option[String] = None, email: Option[String] = None, businessIdentificationNo: Option[String] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None, taxDate: Option[Instant] = None, lines: Option[List[TransactionLineModel]] = None, addresses: Option[List[TransactionAddressModel]] = None, locationTypes: Option[List[TransactionLocationTypeModel]] = None, summary: Option[List[TransactionSummary]] = None, taxDetailsByTaxType: Option[List[TaxDetailsByTaxType]] = None, parameters: Option[Map[String, String]] = None, messages: Option[List[AvaTaxMessage]] = None, invoiceMessages: Option[List[InvoiceMessageModel]] = None) {
