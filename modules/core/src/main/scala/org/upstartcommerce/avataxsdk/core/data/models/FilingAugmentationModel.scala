...
final case class FilingAugmentationModel(id: Option[Long] = None, filingId: Option[Long] = None, fieldAmount: BigDecimal, fieldName: String, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None) {
