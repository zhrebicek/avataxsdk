...
final case class FilingAugmentationModel(id:Option[Long] = None, filingId:Option[Long] = None, fieldAmount:BigDecimal, fieldName:String, createdDate:Option[Date] = None, createdUserId:Option[Int] = None, modifiedDate:Option[Date] = None, modifiedUserId:Option[Int] = None) {
