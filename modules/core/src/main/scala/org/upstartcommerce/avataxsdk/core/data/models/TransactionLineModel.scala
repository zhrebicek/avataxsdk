...
final case class TransactionLineModel(id:Option[Long] = None, transactionId:Option[Long] = None, lineNumber:Option[String] = None, boundaryOverrideId:Option[Int] = None, customerUsageType:Option[String] = None, entityUseCode:Option[String] = None, description:Option[String] = None, destinationAddressId:Option[Long] = None, originAddressId:Option[Long] = None, discountAmount:Option[BigDecimal] = None, discountTypeId:Option[Int] = None, exemptAmount:Option[BigDecimal] = None, exemptCertId:Option[Int] = None, certificateId:Option[String] = None, exemptNo:Option[String] = None, isItemTaxable:Option[Boolean] = None, isSSTP:Option[Boolean] = None, itemCode:Option[String] = None, lineAmount:Option[BigDecimal] = None, quantity:Option[BigDecimal] = None, ref1:Option[String] = None, ref2:Option[String] = None, reportingDate:Option[Date] = None, revAccount:Option[String] = None, sourcing:Option[Sourcing] = None, tax:Option[BigDecimal] = None, taxableAmount:Option[BigDecimal] = None, taxCalculated:Option[BigDecimal] = None, taxCode:Option[String] = None, taxCodeId:Option[Int] = None, taxDate:Option[Date] = None, taxEngine:Option[String] = None, taxOverrideType:Option[TaxOverrideType] = None, businessIdentificationNo:Option[String] = None, taxOverrideAmount:Option[BigDecimal] = None, taxOverrideReason:Option[String] = None, taxIncluded:Option[Boolean] = None, details:List[TransactionLineDetailModel] = List.empty, nonPassthroughDetails:List[TransactionLineDetailModel] = List.empty, lineLocationTypes:List[TransactionLineLocationTypeModel] = List.empty, parameters:Map[String, String] = Map.empty, hsCode:Option[String] = None, costInsuranceFreight:Option[BigDecimal] = None, vatCode:Option[String] = None, vatNumberTypeId:Option[Int] = None) {
  ...
  def withDetails(value:List[TransactionLineDetailModel]):TransactionLineModel = copy(details = value)
  def withNonPassthroughDetails(value:List[TransactionLineDetailModel]):TransactionLineModel = copy(nonPassthroughDetails = value)
  def withLineLocationTypes(value:List[TransactionLineLocationTypeModel]):TransactionLineModel = copy(lineLocationTypes = value)
  def withParameters(value:Map[String, String]):TransactionLineModel = copy(parameters = value)
