...
final case class CommunicationsTSPairModel(transactionTypeId:Int, serviceTypeId:Int, transactionType:Option[String] = None, serviceType:Option[String] = None, description:Option[String] = None, requiredParameters:Option[List[String]] = None) {
  lazy val requiredParametersRaw:List[String] = requiredParameters.getOrElse(List.empty)
  def withTransactionTypeId(value:Int):CommunicationsTSPairModel = copy(transactionTypeId = value)
  def withServiceTypeId(value:Int):CommunicationsTSPairModel = copy(serviceTypeId = value)
