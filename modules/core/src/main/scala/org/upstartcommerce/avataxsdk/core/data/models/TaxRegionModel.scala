...
final case class TaxRegionModel(id: Option[Int] = None, code: Option[String] = None, name: Option[String] = None, county: Option[String] = None, city: Option[String] = None, region: Option[String] = None, country: Option[String] = None, serCode: Option[String] = None, signatureCode: Option[String] = None, effectiveDate: Option[Instant] = None, endDate: Option[Instant] = None, isAcm: Option[Boolean] = None, isSst: Option[Boolean] = None) {
  ...
  def withEffectiveDate(value: Instant): TaxRegionModel = copy(effectiveDate = Some(value))

  def withEndDate(value: Instant): TaxRegionModel = copy(endDate = Some(value))
