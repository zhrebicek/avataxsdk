...
final case class TransactionLineLocationTypeModel(
    documentLineLocationTypeId: Option[Long] = None,
    documentLineId: Option[Long] = None,
    documentAddressId: Option[Long] = None,
    locationTypeCode: Option[String] = None
) {
