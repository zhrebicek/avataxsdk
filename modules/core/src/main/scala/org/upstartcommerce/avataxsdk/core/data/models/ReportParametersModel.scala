...
final case class ReportParametersModel(startDate: Option[Instant] = None, endDate: Option[Instant] = None, country: Option[String] = None, state: Option[String] = None, dateFilter: Option[String] = None, docType: Option[String] = None, dateFormat: Option[String] = None, culture: Option[String] = None, currencyCode: Option[String] = None) {
