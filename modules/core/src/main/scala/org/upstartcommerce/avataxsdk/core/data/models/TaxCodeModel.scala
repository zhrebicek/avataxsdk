...
final case class TaxCodeModel(id: Option[Int] = None, companyId: Option[Int] = None, taxCode: String, taxCodeTypeId: String, description: Option[String] = None, parentTaxCode: Option[String] = None, isPhysical: Option[Boolean] = None, goodsServiceCode: Option[Long] = None, entityUseCode: Option[String] = None, isActive: Option[Boolean] = None, isSSTCertified: Option[Boolean] = None, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None) {
