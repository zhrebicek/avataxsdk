...
final case class FundingConfigurationModel(companyId: Option[Int] = None, systemType: Option[String] = None, currency: Option[String] = None, isFundingSetup: Option[Boolean] = None, fundingMethod: Option[String] = None, lastUpdated: Option[Instant] = None) {
  ...
  def withLastUpdated(value: Instant): FundingConfigurationModel = copy(lastUpdated = Some(value))
}
