...
final case class PointOfSaleDataRequestModel(companyCode: String, documentDate: Option[Instant] = None, responseType: Option[PointOfSaleFileType] = None, taxCodes: Option[List[String]] = None, itemCodes: Option[List[String]] = None, locationCodes: Option[List[String]] = None, includeJurisCodes: Option[Boolean] = None, partnerId: Option[PointOfSalePartnerId] = None) {
  ...
  def withCompanyCode(value: String): PointOfSaleDataRequestModel = copy(companyCode = value)

  def withDocumentDate(value: Instant): PointOfSaleDataRequestModel = copy(documentDate = Some(value))
