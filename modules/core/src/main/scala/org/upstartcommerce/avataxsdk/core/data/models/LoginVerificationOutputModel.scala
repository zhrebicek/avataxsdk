...
final case class LoginVerificationOutputModel(jobId: Int, operationStatus: Option[String] = None, message: Option[String] = None, loginSuccess: Option[Boolean] = None) {
