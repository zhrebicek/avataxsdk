...
final case class AccountModel(id:Int, crmid:Option[String] = None, name:String, effectiveDate:Option[Date] = None, endDate:Option[Date] = None, accountStatusId:Option[AccountStatusId] = None, createdDate:Option[Date] = None, createdUserId:Option[Int] = None, modifiedDate:Option[Date] = None, modifiedUserId:Option[Int] = None, subscriptions:Option[List[SubscriptionModel]] = None, users:Option[List[UserModel]] = None) {
