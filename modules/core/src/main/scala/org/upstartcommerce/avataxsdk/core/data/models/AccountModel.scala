...
final case class AccountModel(id:Option[Int] = None, crmid:Option[String] = None, name:Option[String] = None, effectiveDate:Option[Date] = None, endDate:Option[Date] = None, accountStatusId:Option[AccountStatusId] = None, createdDate:Option[Date] = None, createdUserId:Option[Int] = None, modifiedDate:Option[Date] = None, modifiedUserId:Option[Int] = None, subscriptions:List[SubscriptionModel] = List.empty, users:List[UserModel] = List.empty) {
  ...
  def withSubscriptions(value:List[SubscriptionModel]):AccountModel = copy(subscriptions = value)
  def withUsers(value:List[UserModel]):AccountModel = copy(users = value)
}
