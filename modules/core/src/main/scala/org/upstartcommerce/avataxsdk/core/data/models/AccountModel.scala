...
final case class AccountModel(id: Int, crmid: Option[String] = None, name: String, effectiveDate: Option[Instant] = None, endDate: Option[Instant] = None, accountStatusId: Option[AccountStatusId] = None, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None, subscriptions: Option[List[SubscriptionModel]] = None, users: Option[List[UserModel]] = None) {
  ...
  def withEffectiveDate(value: Instant): AccountModel = copy(effectiveDate = Some(value))

  def withEndDate(value: Instant): AccountModel = copy(endDate = Some(value))

  def withAccountStatusId(value: AccountStatusId): AccountModel = copy(accountStatusId = Some(value))

  def withCreatedDate(value: Instant): AccountModel = copy(createdDate = Some(value))

  def withCreatedUserId(value: Int): AccountModel = copy(createdUserId = Some(value))

  def withModifiedDate(value: Instant): AccountModel = copy(modifiedDate = Some(value))
