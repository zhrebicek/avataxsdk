...
final case class ItemModel(id: Long, companyId: Option[Int] = None, itemCode: String, taxCodeId: Option[Int] = None, taxCode: Option[String] = None, description: String, itemGroup: Option[String] = None, createdDate: Option[Instant] = None, createdUserId: Option[Int] = None, modifiedDate: Option[Instant] = None, modifiedUserId: Option[Int] = None, classifications: Option[List[ClassificationModel]] = None, parameters: Option[List[ItemParameterModel]] = None) {
