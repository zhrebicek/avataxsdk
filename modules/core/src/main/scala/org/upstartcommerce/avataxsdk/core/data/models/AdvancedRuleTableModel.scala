...
final case class AdvancedRuleTableModel(id: Long, accountId: Option[Int] = None, csvTableName: Option[String] = None, csvTable: Option[String] = None) {

  def withId(value: Long): AdvancedRuleTableModel = copy(id = value)
