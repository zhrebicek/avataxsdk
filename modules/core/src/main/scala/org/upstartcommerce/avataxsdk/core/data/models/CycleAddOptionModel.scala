...
final case class CycleAddOptionModel(available: Option[Boolean] = None, transactionalPeriodStart: Option[Instant] = None, transactionalPeriodEnd: Option[Instant] = None, filingDueDate: Option[Instant] = None, cycleName: Option[String] = None, frequencyName: Option[String] = None, filingFrequencyCode: Option[String] = None, filingFrequencyId: Option[FilingFrequencyId] = None, cycleUnavailableReason: Option[String] = None, availableLocationCodes: Option[List[String]] = None) {
  ...
  def withTransactionalPeriodStart(value: Instant): CycleAddOptionModel = copy(transactionalPeriodStart = Some(value))

  def withTransactionalPeriodEnd(value: Instant): CycleAddOptionModel = copy(transactionalPeriodEnd = Some(value))

  def withFilingDueDate(value: Instant): CycleAddOptionModel = copy(filingDueDate = Some(value))
